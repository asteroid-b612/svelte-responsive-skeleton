...
import iphoneImg from './assets/iphone.png'
	...
	// import valuesImg from './assets/values-bg.png'
</script>
  ...
  <div class="container">
    <div class="row">
      <div class="one-half column">
        ...
        <a class="button button-primary" href="http://getskeleton.com"
          >Try Skeleton</a
        >
      </div>
      <div class="one-half column phones">
        <img class="phone" src={iphoneImg} alt="a phone" />
        <img class="phone" src={iphoneImg} alt="a phone"  />
      </div>
    </div>
  </div>
...
<div class="section get-help">
  <div class="container">
    ...
    <p class="section-description">
      Skeleton is an amazingly easy place to start with responsive development.
      If you want to learn more, just visit the documentation!
    </p>
    <a class="button button-primary" href="http://getskeleton.com"
      >View Skeleton Docs</a
    >
  </div>
</div>
...
<div class="section categories">
  <div class="container">
    ...
    <p class="section-description">
      Skeleton images sit easily in grid with .u-max-full-width class. I suggest
      exploring solution to serving different images based on device size.
    </p>
    <div class="row">
      <div class="one-half column category">
        <img class="u-max-full-width" src={placeholderImg} />
      </div>
      <div class="one-half column category">
        <img class="u-max-full-width" src={placeholderImg} />
      </div>
